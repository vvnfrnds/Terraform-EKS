...
resource "aws_eip" "nat" {                          //Create Elastic IP for NAT Gateway
  count = length(var.public_subnet_cidrs)
  domain = "vpc"
...
resource "aws_route_table" "private" {              //Create Route Table for Private Subnet
    count = length(var.private_subnet_cidrs)
    vpc_id = aws_vpc.main.id
...
resource "aws_route_table_association" "private" {          //Create Route Table Association for Private Subnet
    count = length(var.private_subnet_cidrs)
